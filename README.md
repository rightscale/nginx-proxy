...
**The purpose of this fork is to upgrade nginx to 1.11 to solve http/2 issues, specifically getting REFUSED_STREAM errors with the golang 1.7 HTTP library**
